        ...
        return(
            <>
                <div className="container-fluid">
                    <h1 className="h3 mb-1 text-gray-800">District</h1>
                                ...
                                <div className="card-body">
                                    <form className="row">
                                        ...
                                        <div className="row-highlight col-sm-12 bg-gray-200">
                                            <div className="col-md-6">
                                                <div className="form-group row">
                                                    <label htmlFor="inputCountrySelect" className="col-sm-4 col-form-label margin-top-rem-1 label-bold label-mandatory">Country</label>
                                                    <label className="col-sm-1 col-form-label margin-top-rem-1">:</label>
                                        ...
                                        <div className="col-sm-12">
                                            <div className="form-group row margin-top-rem-1">
                                                ...
                                                <div className="col-md-4">
                                                    <button type="button" className="btn btn-primary btn-min-width margin-top-rem-1 ">Search</button>
                                                    &nbsp;
