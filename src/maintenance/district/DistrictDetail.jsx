...
class DistrictDetail extends Component {
    ...
    editOnClick = () => {
        window.location = "/districtUpdate";
    }
        ...
        return(
            <>
                <div className="container-fluid">
                    <h1 className="h3 mb-1 text-gray-800">INDONESIA &gt; DKI JAKARTA &gt; JAKARTA PUSAT &gt; District</h1>
                    ...
                    <div className="row">
                        <div className="col-lg-12">
                                        ...
                                        <div className="row-highlight col-sm-12 bg-gray-100">
                                            <div className="col-md-6">
                                                <div className="form-group row">
                                                    ...
                                                    <label className="col-sm-7 col-form-label margin-top-rem-1 label-bold">317106</label>
                                                </div>
                                            </div>
                                            <div className="col-md-6">
                                                <div className="form-group row">
                                                    ...
                                                    <label className="col-sm-1 col-form-label margin-top-rem-1">:</label>
                                                    <label className="col-sm-7 col-form-label margin-top-rem-1 label-bold">MENTENG</label>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div className="card shadow mb-4">
                                <div className="card-header py-3">
                                    <h6 className="m-0 font-weight-bold text-primary">Village List</h6>
                                </div>
