        ...
        return(
            <>
                <div className="container-fluid">
                    <h1 className="h3 mb-1 text-gray-800">INDONESIA &gt; DKI JAKARTA &gt; JAKARTA PUSAT &gt; MENTENG &gt; Village</h1>
                    ...
                    <div className="row">
                        <div className="col-lg-12">
                                        ...
                                        <div className="row-highlight col-sm-12 bg-gray-100">
                                            <div className="col-md-6">
                                                <div className="form-group row">
                                                    ...
                                                    <label className="col-sm-7 col-form-label margin-top-rem-1 label-bold">3171061003</label>
                                                </div>
                                            </div>
                                            <div className="col-md-6">
                                                <div className="form-group row">
                                                    ...
                                                    <label className="col-sm-1 col-form-label margin-top-rem-1">:</label>
                                                    <label className="col-sm-7 col-form-label margin-top-rem-1 label-bold">CIKINI</label>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div className="col-12">
                                            <div className="form-group row margin-top-rem-1">
                                                ...
                                                <div className="col-sm-1">
                                                    <button type="submit" className="btn btn-primary btn-min-width">Approve</button>                                           
                                                </div>
                                                <div className="col-sm-1">
                                                    <button type="button" className="btn btn-primary btn-min-width" onClick={this.editOnClick}>Edit</button>
                                                </div>
                                                <div className="col-sm-1">
                                                    <button type="button" className="btn btn-primary btn-min-width" onClick={this.backOnClick}>Back</button>
                                                </div>
                                            </div>
                                        </div>
                                    </form>              
                            ...
                            <div className="card shadow mb-4">
                                <div className="card-header py-3">
                                    <h6 className="m-0 font-weight-bold text-primary">Postal List</h6>
                                </div>
                                    ...
                                    <div className="table-responsive">
                                        <table className="table table-bordered" id="dataTable" width="100%" cellSpacing="0">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td><a href="/postalDetail">Airi Satou</a></td>
                                                    <td>Accountant</td>
                                                    <td>Tokyo</td>
                                                    <td>33</td>
                                                    <td>2008/11/28</td>
