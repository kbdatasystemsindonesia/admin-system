            ...
            <nav className="navbar navbar-expand navbar-light navbar-bg">
                ...
                <ul className="navbar-nav d-none d-lg-flex">
                    <li className="nav-item px-2 dropdown">
                        <a className="nav-link dropdown-toggle" href="#" id="megaDropdown" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            Mega Menu
                        </a>
                    ...
                    <li className="nav-item dropdown">
                        <a className="nav-link dropdown-toggle" href="#" id="resourcesDropdown" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Resources</a>
                        
                        <div className="dropdown-menu" aria-labelledby="resourcesDropdown">
                            <a className="dropdown-item" href="https://adminkit.io/" target="_blank"><i className="align-middle me-1" data-feather="home"></i>Homepage</a>
                            <a className="dropdown-item" href="https://adminkit.io/docs/" target="_blank"><i className="align-middle me-1" data-feather="book-open"></i>Documentation</a>
                            <a className="dropdown-item" href="https://adminkit.io/docs/getting-started/changelog/" target="_blank"><i className="align-middle me-1" data-feather="edit"></i> Changelog</a>
                        </div>
                    </li>
                </ul>
